...
async def alivehi(client: Client, message):
    ...
    await message.reply_video(
        video=VIDEO,
        caption="╭───── : ◖⋮◗ : ─────╮\n么 [᥉ᥱꪔ᥆ ᥱᥣkႦᥱᖇ ™](https://t.me/Almortagel_12)\n么 [᥉᥆υᖇᥴᥱ ᥱᥣꪀᘜ᥆᥆ꪔ ™](https://t.me/AlmortagelTech)\n么 [ᘜᖇ᥆υρ ᥱᥣꪀᘜ᥆᥆ꪔ ™](https://t.me/AlmortagelTech)\n╰──── : ◖⋮◗ : ────╯\n: ƚ𝗁ᥱ Ⴆᥱ᥉ƚ ᥉᥆υᖇᥴᥱ ᥆ꪀ ƚᥱᥣᥱᘜᖇᥲ️ꪔ :",
        reply_markup=keyboard,
    )

@app.on_message(filters.command(["صاحب السورس", "المرتجل", "المرتجل", "مطور السورس",": مطور السورس :"], "") & ~filters.private)
